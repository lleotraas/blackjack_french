...
//            deck.deckList.add(Card(NumberType.ACE,ColorType.HEART,1))
//            deck.deckList.add(Card(NumberType.SEVEN,ColorType.SPADE,7))
//            deck.deckList.add(Card(NumberType.HEIGHT,ColorType.DIAMOND,8))
//            deck.deckList.add(Card(NumberType.JACK,ColorType.SPADE,10))
//            deck.deckList.add(Card(NumberType.TWO,ColorType.SPADE,2))
//            deck.deckList.add(Card(NumberType.FIVE,ColorType.HEART,5))
//            deck.deckList.add(Card(NumberType.SIX,ColorType.DIAMOND,6))
//            deck.deckList.add(Card(NumberType.THREE,ColorType.HEART,3))
//            deck.deckList.add(Card(NumberType.TEN,ColorType.HEART,10))
//            deck.deckList.add(Card(NumberType.NINE,ColorType.SPADE,9))
