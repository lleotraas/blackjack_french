...
class MorphButton @JvmOverloads constructor(
    ...
    var toBgColor: Int = getColorX(R.color.white)
    var fromTextColor: Int = getColorX(R.color.black)
    var toTextColor: Int = getColorX(R.color.purple_200)

    var btnRadius = 24 * dp()

    var iconDrawable = getDrawableX(R.drawable.baseline_block_24)
        set(value) {
            field = value
            setSizeIcon()
        }
