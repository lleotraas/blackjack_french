...
class HitHelpDialog : DialogFragment() {
    ...
    private fun updateUi() {
        binding.apply {
            helpDialogTitleTv.text = requireContext().resources.getString(R.string.hit_help_dialog_title)
            helpDialogMessageTv.text = requireContext().resources.getString(R.string.hit_help_dialog_message)
            helpDialogContextualImg.background = ContextCompat.getDrawable(requireContext(), R.drawable.hit_btn)
        }
    }
