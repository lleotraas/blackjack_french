...
class RebuyHelpDialog : DialogFragment() {
    ...
    private fun updateUi() {
        binding.apply {
            helpDialogTitleTv.text = requireContext().resources.getString(R.string.rebuy_help_dialog_title)
            helpDialogMessageTv.text = requireContext().resources.getString(R.string.rebuy_help_dialog_message)
            helpDialogContextualImg.background = ContextCompat.getDrawable(requireContext(), R.drawable.rebuy_btn)
        }
    }
